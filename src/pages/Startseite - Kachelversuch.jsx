...
import ReklamationenKachel from '../components/ReklamationenKachel'; // Pfad anpassen falls nötig
...
function Startseite() {
  ...
  return (
    <div className="relative w-screen h-screen bg-[#3A3838] overflow-hidden">
      ...
      <div className="absolute top-[20px] text-xl font-semibold text-white cursor-pointer select-none"
